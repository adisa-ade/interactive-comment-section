...
console.log(data.comments)
  const addComment = () => {
    data.comments.push({
      content: "Lorem ipsum dolor sit amet Lorem ipsum dolor sit amet consectetur adipisicing elit. Asperiores eligendi delectus, veritatis voluptatibus quod veniam? Cumque, iure esse inventore et ratione dolor totam quam, expedita, ex ullam explicabo quae nobis.",    
  ...
  return (
    <div className="lg:w-5xl lg:mx-auto">
      {comments.map((comment, index) => (
        <div key={index}>
          <div className="bg-(--white) mx-6 mt-6 rounded-[10px] p-6 space-y-4 ">
          ...
          {openReplyIndex === index && <AddComment />}
        </div>
      ))}
